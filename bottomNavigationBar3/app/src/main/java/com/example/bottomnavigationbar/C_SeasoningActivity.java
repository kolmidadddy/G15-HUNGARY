...
public class C_SeasoningActivity extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(list.isEmpty()){
                    Toast.makeText(C_SeasoningActivity.this,"Seasoning Category is empty!",Toast.LENGTH_LONG).show();
                }
                else{
                    TextView category_name=findViewById(R.id.category_name);
                    category_name.setText("Seasoning");
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(C_SeasoningActivity.this, C_CategoryFull.class);
