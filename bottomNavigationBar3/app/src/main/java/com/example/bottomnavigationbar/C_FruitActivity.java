...
public class C_FruitActivity extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(list.isEmpty()){
                    Toast.makeText(C_FruitActivity.this,"Fruit Category is empty!",Toast.LENGTH_LONG).show();
                }
                else{
                    TextView category_name=findViewById(R.id.category_name);
                    category_name.setText("Fruit");
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(C_FruitActivity.this, C_CategoryFull.class);
