...
public class C_MeatActivity extends AppCompatActivity implements RecyclerViewInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(list.isEmpty()){
                    Toast.makeText(C_MeatActivity.this,"Meat Category is empty!",Toast.LENGTH_LONG).show();
                }
                else{
                    TextView category_name=findViewById(R.id.category_name);
                    category_name.setText("Meat/Fish");
    ...
    public void onItemClick(int position) {
        Intent intent=new Intent(C_MeatActivity.this, C_CategoryFull.class);
